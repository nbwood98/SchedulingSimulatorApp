...
public class SimulationController {
    ...
    private XYDataset createDataset() {
        ...
        double[][] data = {{0.0, 2.68, 2.68, 8.0, 8.0, 9.83, 9.83},
                           {.746, .746, 0.0, 0.0, .546, .546, 0.0}};
        double[][] data2 = {{0.0, 2.68, 2.68, 4.29, 4.29, 10,10, 12.016,12.015},
                            {0.0, 0.0, 0.621, 0.621, 0, 0, 0.496, 0, 0}};
        double[][] data3 = {{0.0, 0.0, 4.29, 4.29, 6.66, 6.66, 14,14,17.37,17.37},
                            {0.0, 0.0, 0.421, 0.0, 0.0,  0.296, 0.296, 0.0, 0.0}};
